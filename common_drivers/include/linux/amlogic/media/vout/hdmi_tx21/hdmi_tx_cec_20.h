...
#define CEC_TV                   BIT(CEC_TV_ADDR)
#define CEC_RECORDING_DEVICE_1   BIT(CEC_RECORDING_DEVICE_1_ADDR)
#define CEC_RECORDING_DEVICE_2   BIT(CEC_RECORDING_DEVICE_2_ADDR)
#define CEC_TUNER_1              BIT(CEC_TUNER_1_ADDR)
#define CEC_PLAYBACK_DEVICE_1    BIT(CEC_PLAYBACK_DEVICE_1_ADDR)
#define CEC_AUDIO_SYSTEM         BIT(CEC_AUDIO_SYSTEM_ADDR)
#define CEC_TUNER_2              BIT(CEC_TUNER_2_ADDR)
#define CEC_TUNER_3              BIT(CEC_TUNER_3_ADDR)
#define CEC_PLAYBACK_DEVICE_2    BIT(CEC_PLAYBACK_DEVICE_2_ADDR)
#define CEC_RECORDING_DEVICE_3   BIT(CEC_RECORDING_DEVICE_3_ADDR)
#define CEC_TUNER_4              BIT(CEC_TUNER_4_ADDR)
#define CEC_PLAYBACK_DEVICE_3    BIT(CEC_PLAYBACK_DEVICE_3_ADDR)
#define CEC_RESERVED_1           BIT(CEC_RESERVED_1_ADDR)
#define CEC_RESERVED_2           BIT(CEC_RESERVED_2_ADDR)
#define CEC_FREE_USE             BIT(CEC_FREE_USE_ADDR)
#define CEC_UNREGISTERED         BIT(CEC_UNREGISTERED_ADDR)
...
struct cec_global_info_t {
	dev_t dev_no;
	atomic_t open_count;
	u32 hal_ctl;			/* message controlled by hal */
	u32 vendor_id:24;
	u32 menu_lang;
	u32 cec_version;
	u8 power_status;
...
int cec_ll_tx(const u8 *msg, u8 len);
int cec_ll_rx(u8 *msg, u8 *len);
