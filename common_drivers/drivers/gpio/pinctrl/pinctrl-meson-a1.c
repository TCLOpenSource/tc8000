...
#ifdef GPIO_TEST_N
/* TEST_N */
static const struct pinctrl_pin_desc meson_a1_testn_pins[] = {
	MESON_PIN(GPIO_TEST_N),
};

static const unsigned int testn_pins[] = {GPIO_TEST_N};

static struct meson_pmx_group meson_a1_testn_groups[] = {
...
static struct meson_pmx_func meson_a1_testn_functions[] = {
	FUNCTION(gpio_testn),
};

static struct meson_bank meson_a1_testn_banks[] = {
	BANK_DS("TEST_N",    GPIO_TEST_N,    GPIO_TEST_N,   -1, -3,
		 0x4,  0,  0x3,  0,  0x2,  0,  0x01,  0,  0x0,  0, 0x5, 0),
};

static struct meson_pmx_bank meson_a1_testn_pmx_banks[] = {
	BANK_PMX("TEST_N", GPIO_TEST_N, GPIO_TEST_N, 0, 0),
};

static struct meson_axg_pmx_data meson_a1_testn_pmx_banks_data = {
	.pmx_banks      = meson_a1_testn_pmx_banks,
	.num_pmx_banks  = ARRAY_SIZE(meson_a1_testn_pmx_banks),
};

static struct meson_pinctrl_data meson_a1_testn_pinctrl_data = {
	.name           = "testn-banks",
	.pins           = meson_a1_testn_pins,
	.groups         = meson_a1_testn_groups,
	.funcs          = meson_a1_testn_functions,
	.banks          = meson_a1_testn_banks,
	.num_pins       = ARRAY_SIZE(meson_a1_testn_pins),
	.num_groups     = ARRAY_SIZE(meson_a1_testn_groups),
	.num_funcs      = ARRAY_SIZE(meson_a1_testn_functions),
	.num_banks      = ARRAY_SIZE(meson_a1_testn_banks),
	.pmx_ops        = &meson_axg_pmx_ops,
	.pmx_data       = &meson_a1_testn_pmx_banks_data,
...
static const struct of_device_id meson_a1_pinctrl_dt_match[] = {
...
#ifdef GPIO_TEST_N
	{
		...
		.data = &meson_a1_testn_pinctrl_data,
	},
#endif
	{ },
};
...
{
	meson_a1_pinctrl_driver.driver.of_match_table =
