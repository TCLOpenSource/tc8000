...
static struct meson_pmx_group meson_c2_periphs_groups[] __initdata = {
	GPIO_GROUP(GPIOD_0),
	GPIO_GROUP(GPIOD_1),
	GPIO_GROUP(GPIOD_2),
	GPIO_GROUP(GPIOD_3),
...
static struct meson_pmx_func meson_c2_periphs_functions[] __initdata = {
...
static struct meson_bank meson_c2_periphs_banks[] = {
	...
	BANK_REF("D", GPIOD_0,    GPIOD_13,  0,  13,
		 0x3,   0,  0x4,  0,   0x2,  0,  0x1,  0,  0x0,  0, 0x05, 0, 0x06, 0),
	BANK_REF("E", GPIOE_0,    GPIOE_2,   14, 16,
		 0x13,  0,  0x14,  0,  0x12, 0,  0x11, 0,  0x10, 0, 0x15, 0, 0x16, 0),
	BANK_REF("B", GPIOB_0,    GPIOB_13,  17, 30,
		 0x23,  0,  0x24,  0,  0x22, 0,  0x21, 0,  0x20, 0, 0x25, 0, 0x26, 0),
	BANK_REF("C", GPIOC_0,    GPIOC_6,   31, 37,
		 0x33,  0,  0x34,  0,  0x32, 0,  0x31, 0,  0x30, 0, 0x35, 0, 0x36, 0),
	BANK_REF("X", GPIOX_0,    GPIOX_20,  38, 58,
		 0x43,  0,  0x44,  0,  0x42, 0,  0x41, 0,  0x40, 0, 0x45, 0, 0x47, 0),
	BANK_REF("M", GPIOM_0,    GPIOM_13,  59, 72,
		 0x53,  0,  0x54,  0,  0x52, 0,  0x51, 0,  0x50, 0, 0x55, 0, 0x56, 0),
	BANK_REF("A", GPIOA_0,    GPIOA_15,  73, 88,
		 0x63,  0,  0x64,  0,  0x62, 0,  0x61, 0,  0x60, 0, 0x65, 0, 0x66, 0),
	BANK_REF("TEST_N", GPIO_TEST_N,    GPIO_TEST_N,   89, 89,
		 0x73,  0,  0x74,  0,  0x72, 0,  0x71,  0, 0x70, 0, 0x75, 0, 0x76, 0),
};
...
static struct meson_pinctrl_data meson_c2_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
...
static int __init meson_c2_pinctrl_init(void)
{
	meson_c2_pinctrl_driver.driver.of_match_table =
				meson_c2_pinctrl_dt_match;
