...
/* 20230307: if not data input not print reminder */
...
enum vdin_hw_ver_e {
	...
	VDIN_HW_TM2_B,
	/*
	 * sc2, sm1 vdin0 up to 4k, vdin1 up to 1080P (write)
	 * no afbce
	 */
	VDIN_HW_SC2,
	VDIN_HW_T5,
...
#define VDIN_INPUT_MAX_FPS		5000 // max_fps<200HZ
