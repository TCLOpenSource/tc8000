...
static struct meson_msr_id clk_msr_c3[] __initdata = {
	...
	CLK_MSR_ID(5,	"sys_pll_clk"),
	CLK_MSR_ID(6,	"sys_cpu_clk_div16"),
	CLK_MSR_ID(7,	"ts_pll_clk"),
	...
	CLK_MSR_ID(30,	"mod_eth_phy_ref_clk"),
	CLK_MSR_ID(31,	"mod_eth_tx_clk"),
	CLK_MSR_ID(32,	"cts_eth_clk_125Mhz"),
	CLK_MSR_ID(33,	"cts_eth_clk_rmii"),
	CLK_MSR_ID(34,	"co_clkin_to_mac"),
	CLK_MSR_ID(36,	"co_rx_clk"),
	CLK_MSR_ID(37,	"co_tx_clk"),
	...
	CLK_MSR_ID(39,	"eth_phy_plltxclk"),
	CLK_MSR_ID(40,	"ephy_test_clk"),
	CLK_MSR_ID(66,	"cts_vapb_clk"),
	CLK_MSR_ID(67,	"cts_ge2d_clk"),
	CLK_MSR_ID(68,	"cts_dewarpa_clk"),
	CLK_MSR_ID(70,	"cts_dsi_meas_clk"),
	CLK_MSR_ID(71,	"cts_dsi_phy_clk"),
	CLK_MSR_ID(79,	"cts_rama_clk?"),
	CLK_MSR_ID(94,	"clk_vc9000e_core_clk"),
	CLK_MSR_ID(95,	"clk_sys_vc9000e"),
	CLK_MSR_ID(96,	"cts_vc9000e_clk"),
	CLK_MSR_ID(97,	"cts_hcodec_clk"),
	CLK_MSR_ID(106,	"deskew_pll_clk_div32_out"),
	CLK_MSR_ID(107,	"mipi_csi_phy_clk_out[0]"),
	CLK_MSR_ID(108,	"mipi_csi_phy_clk_out[1]"),
	CLK_MSR_ID(110,	"cts_spifc_clk"),
	CLK_MSR_ID(111,	"cts_sar_adc_clk"),
	...
	CLK_MSR_ID(160,	"pwm_n_clk"),
	CLK_MSR_ID(161,	"pwm_m_clk"),
	CLK_MSR_ID(162,	"pwm_l_clk"),
	CLK_MSR_ID(163,	"pwm_k_clk"),
	CLK_MSR_ID(164,	"pwm_j_clk"),
	CLK_MSR_ID(165,	"pwm_i_clk"),
	CLK_MSR_ID(166,	"pwm_h_clk"),
	CLK_MSR_ID(167,	"pwm_g_clk"),
	CLK_MSR_ID(168,	"pwm_f_clk"),
	CLK_MSR_ID(169,	"pwm_e_clk"),
	CLK_MSR_ID(170,	"pwm_d_clk"),
	CLK_MSR_ID(171,	"pwm_c_clk"),
	CLK_MSR_ID(172,	"pwm_b_clk"),
	CLK_MSR_ID(173,	"pwm_a_clk"),
...
static struct meson_msr_id clk_msr_t5m[] __initdata = {
	CLK_MSR_ID(0, "cts_sys_clk"),
	CLK_MSR_ID(1, "cts_axi_clk"),
	CLK_MSR_ID(2, "cts_rtc_clk"),
	CLK_MSR_ID(5, "cts_mali_clk"),
	...
	CLK_MSR_ID(24, "ddr0_dpll_pt_clk"),
	CLK_MSR_ID(25, "ddr1_dpll_pt_clk"),
	CLK_MSR_ID(28, "ddr1_deskew_pll_test_clk"),
	CLK_MSR_ID(29, "ddr0_deskew_pll_test_clk"),
	CLK_MSR_ID(30, "mod_eth_phy_ref_clk"),
	CLK_MSR_ID(31, "mod_eth_tx_clk"),
	CLK_MSR_ID(32, "cts_eth_clk125Mhz"),
	CLK_MSR_ID(33, "cts_eth_clk_rmii"),
	...
	CLK_MSR_ID(201, "cts_atv_dmd_vdac_clk"),
	CLK_MSR_ID(202, "cts_atv_dmd_sys_clk"),
	CLK_MSR_ID(203, "cts_tsin_deglitch_clk"),
	CLK_MSR_ID(206, "am_ring_out20"),
	CLK_MSR_ID(207, "am_ring_out21"),
	CLK_MSR_ID(208, "am_ring_out22"),
	CLK_MSR_ID(209, "am_ring_out23"),
...
static struct meson_msr_data meson_c3_data __initdata = {
	...
	.table_size = ARRAY_SIZE(clk_msr_c3),
	.duty_offset = (0x4 * 6),
	.reg0_offset = 0x0,
	.reg1_offset = 0x4,
	.reg2_offset = 0x8,
...
static struct meson_msr_data meson_t5m_data __initdata = {
	.msr_table = (struct meson_msr_id *)&clk_msr_t5m,
	.table_size = ARRAY_SIZE(clk_msr_t5m),
	.duty_offset = (0x6 * 4),
	.reg0_offset = 0x0,
	.reg1_offset = 0x4,
	.reg2_offset = 0x8,
