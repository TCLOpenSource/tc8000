...
static int tas5707_suspend(struct snd_soc_component *component)
{
	...
	/*save volume */
	tas5707->ch1_vol = snd_soc_component_read(component, DDX_CHANNEL1_VOL);
	tas5707->ch2_vol = snd_soc_component_read(component, DDX_CHANNEL2_VOL);
	tas5707->master_vol = snd_soc_component_read(component, DDX_MASTER_VOLUME);
