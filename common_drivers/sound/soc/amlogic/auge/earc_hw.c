...
void earctx_dmac_hold_bus_and_mute(struct regmap *dmac_map)
{
	if (!dmac_map)
		return;
	earctx_set_cs_mute(dmac_map, 1);
	msleep(105);
	...
	//			 0x0 << 28);
	/*
	 * wait EARCTX_CMDC_STATUS_CH, otherwise it is sound drop one time
	 * on sony HT-X8500 soundbar
	 */
	//msleep(1900);
	//msleep(105);
	earctx_set_cs_mute(dmac_map, 0);
