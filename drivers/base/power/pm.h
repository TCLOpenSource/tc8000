...
enum suspend_states {
	SUSPEND_STATE_BEGIN,
	SUSPEND_STATE_END,
	SUSPEND_STATE_FREEZE_END,
	SUSPEND_STATE_RESUME_END,
	SUSPEND_STATE_INPUT_DISABLE,
	SUSPEND_STATE_INPUT_ENABLE,
	SUSPEND_STATE_NONE
};

#define EN_FPP_POWER_STR 0
#define EN_FPP_POWER_NORMAL 1
